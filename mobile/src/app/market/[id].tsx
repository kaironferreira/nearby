...
import { Cover } from "@/components/market/corver";
...
export default function Market() {
    ...
    const [isVisibleCameraModal, setIsVisibleCameraMoral] = useState(false)
        ...
        <View style={{ flex: 1 }}>
            ...
            <Modal style={{ flex: 1 }} visible={isVisibleCameraModal}>
                ...
                <View style={{ position: 'absolute', bottom: 32, left: 32, right: 32 }}>
                    <Button onPress={() => setIsVisibleCameraMoral(false)} isLoading={couponIsFetching}>
